...
<div class="page-header">
    <div class="page-title">
        <h4>Création de rôle</h4>
        <h6>Créer des rôles et assigner des permissions</h6>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Entrez le nom du rôle" required>
                    </div>
                </div>
            </div>
