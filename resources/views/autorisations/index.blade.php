            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-end">
                    <div class="d-flex justify-content-end align-items-center">
                        <span class="me-2 text-muted">Total: {{ $autorisations->count() }} autorisations</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div id="folder-list" class="mb-2">
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        <h5 class="fs-16 mb-0">Liste des Autorisations</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" id="folderlist-data">
                            @forelse ($autorisations as $autorisation)
                                <div class="col-xxl-3 col-lg-4 col-md-6 col-sm-12 folder-card" data-status="{{ $autorisation->statut }}">
                                    <div class="card project-card shadow-sm border-0 h-100" id="folder-{{ $autorisation->id }}">
                                        <div class="card-body position-relative">
                                            @php
                                                ...
                                                $config = $statusConfig[$autorisation->statut] ?? ['text' => 'Inconnu', 'color' => 'secondary', 'bg' => 'secondary'];
                                            @endphp
                                            ...
                                            <div class="text-center mt-4 mb-3">
                                                <div class="folder-icon-wrapper">
                                                    <svg width="80" height="64" viewBox="0 0 80 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M8 8C8 5.79086 9.79086 4 12 4H32L40 12H68C70.2091 12 72 13.7909 72 16V52C72 54.2091 70.2091 56 68 56H12C9.79086 56 8 54.2091 8 52V8Z" fill="#FFC107" stroke="#FFA000" stroke-width="2"/>
                                                        <path d="M8 16H72V52C72 54.2091 70.2091 56 68 56H12C9.79086 56 8 54.2091 8 52V16Z" fill="#FFD54F"/>
                                                    </svg>
                                                </div>
                                            </div>
                                            
                                            <div class="text-center">
                                                <h6 class="project-title mb-2">Autorisation N°{{ $autorisation->id }}</h6>
                                                <p class="project-subtitle text-muted mb-3">{{ Str::limit($autorisation->description, 35) }}</p>
                                            </div>
                                            ...
                                            <div class="project-details">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <small class="fw-bold">
                                                        <a href="{{ route('projets.show', $autorisation->projet) }}" class="text-dark">{{ Str::limit($autorisation->projet->titre, 15) }}</a>
                                                    </small>
                                                </div>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <small class="text-muted">Responsable:</small>
                                                    <small class="fw-bold">{{ $autorisation->responsable->prenom }}</small>
                                                </div>
                                            </div>
                            ...
                            @empty
                                <div class="col-12">
                                    <div class="text-center py-5">
                                        ...
                                        <h5 class="text-muted">Aucune autorisation trouvée</h5>
                                        <p class="text-muted">Commencez par créer une nouvelle activité de type "autorisation"</p>
